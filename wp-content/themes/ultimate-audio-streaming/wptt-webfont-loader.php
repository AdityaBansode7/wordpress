...
if ( ! class_exists( 'Ultimate_Audio_Streaming_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Ultimate_Audio_Streaming_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Ultimate_Audio_Streaming_WPTT_WebFont_Loader( $url );
